...
class PubMedDownloader:
    def __init__(self, subset, save_path):
        ...
        self.save_path = os.path.join(self.save_path, subset)
...
def main(args):
    downloader = PubMedDownloader(args.dataset[7:], args.download_loc)
    downloader.download()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--download_loc',
        type=str,
        default='/raid/datasets/pubmed_megatron/download'
    )
